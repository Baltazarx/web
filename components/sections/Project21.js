                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="tf-title" data-aos="fade-up" data-aos-duration={800}>
                                <h2 className="title">
                                    Projects that promise a lot <br className="show-destop" /> of potential
                                </h2>
                            </div>
                        </div>
                        <div className="col-md-12">
                            <div className="container_inner">
                                <div className="swiper-container slider-2" data-aos="fade-in" data-aos-duration={1000}>
                                    <Swiper {...swiperOptions} className="swiper-wrapper">
                                            ...
                                            <div className="project-box">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <div className="content-inner">
                                                        <h5 className="heading"><Link href="/./project-list">Zombie plant 2</Link>
                                                        </h5>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                ...
                                                                <p className="price">100K</p>
                                                            </li>
                                                            <li>
                                                                <p className="text">Valuation:</p>
                                                ...
                                                <Link href="/project-list" className="tf-button style1">
                                                    EXPLORE
                                                </Link>
                                            </div>
                                        </SwiperSlide>
                                        ...
                                        <SwiperSlide>
                                            <div className="project-box">
                                                <div className="image">
                                                    <img className="mask" src="/assets/images/common/project_4.png" alt="" />
                                                    <div className="shape">
                                                        <img src="/assets/images/common/shape.png" alt="" />
                                                    </div>
                                                </div>
                                                <div className="content">
                                                    <span className="boder" />
                                                    <div className="content-inner">
                                                        <h5 className="heading"><Link href="/project-list">Iron Blade</Link></h5>
                                                        <p className="desc">Lorem ipsum dolor sit amet, consectetur adipiscing
                                                            elit.
                                                            Praesent varius risus sed pellentesque</p>
                                                        <ul>
                                ...
                                <div className="next_slider-2 next_slider"><svg width={18} height={16} viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="prev_slider-2 prev_slider"><svg width={18} height={16} viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
